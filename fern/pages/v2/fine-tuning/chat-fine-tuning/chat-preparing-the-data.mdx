...
- The system message is always kept within the context window. This means that the system message and _all turns within the context window_ should be within 16384 tokens.
