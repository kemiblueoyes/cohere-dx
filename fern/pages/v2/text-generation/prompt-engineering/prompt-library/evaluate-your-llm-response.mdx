...
slug: "v2/docs/evaluate-your-llm-response"
...
---
You can leverage [Command A](/v2/docs/command-a) to evaluate natural language responses that cannot be easily scored with manual rules.
