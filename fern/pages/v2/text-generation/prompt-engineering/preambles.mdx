...
slug: "v2/docs/system-instructions"
...
To set a custom system instruction, use the `messages` parameter's "system" role in the Chat API. This would append a new section called `Developer Preamble` to the system message above.
