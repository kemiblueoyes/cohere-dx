...
Our vocabulary of tokens is created using [byte pair encoding](https://en.wikipedia.org/wiki/Byte_pair_encoding).
...
co.tokenize(
    text="caterpillar", model="command-a-plus-05-2026"
)  # -> [74, 2340,107771]
```
...
co.tokenize(
    text="caterpillar", model="command-a-plus-05-2026", offline=False
