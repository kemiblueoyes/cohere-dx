...
<Note title="This Guide Uses the Embed Jobs API.">  
 Refer to the [API reference](/reference/create-embed-job) for more details.
...
If your dataset hits a validation error, please refer to the dataset validation errors section on the [datasets](datasets) page to debug the issue.
