---
title: Reranking - Cohere on Azure AI Foundry
slug: /v2/docs/cohere-on-azure/azure-ai-reranking

description: "A guide for performing reranking with Cohere's Reranking models on Azure AI Foundry (API v2)."
