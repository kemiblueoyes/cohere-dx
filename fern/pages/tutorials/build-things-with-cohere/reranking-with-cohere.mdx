...
The Rerank models (`rerank-v4.0-pro`, `rerank-v3.5`, and `rerank-multilingual-v3.0`) support 100+ languages. This means you can perform semantic search on texts in different languages.
