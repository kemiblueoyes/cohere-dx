...
co_chat = cohere.Client(
    api_key="AZURE_CHAT_INFERENCE_CREDENTIAL",
    base_url="AZURE_CHAT_ENDPOINT",  # example: "https://cohere-command-r-plus-08-2024-xyz.eastus.models.ai.azure.com/"
)

co_embed = cohere.Client(
    api_key="AZURE_EMBED_INFERENCE_CREDENTIAL",
    base_url="AZURE_EMBED_ENDPOINT",  # example: "https://cohere-embed-v3-multilingual-xyz.eastus.models.ai.azure.com/"
)

co_rerank = cohere.Client(
    api_key="AZURE_RERANK_INFERENCE_CREDENTIAL",
    base_url="AZURE_RERANK_ENDPOINT",  # example: "https://cohere-rerank-v3-multilingual-xyz.eastus.models.ai.azure.com/"
)
```
