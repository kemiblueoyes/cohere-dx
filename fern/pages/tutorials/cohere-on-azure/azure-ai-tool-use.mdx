...
api_key_chat = "AZURE_CHAT_INFERENCE_CREDENTIAL"
endpoint_chat = "AZURE_CHAT_ENDPOINT"  # example: "https://cohere-command-r-plus-08-2024-xyz.eastus.models.ai.azure.com/"
```
