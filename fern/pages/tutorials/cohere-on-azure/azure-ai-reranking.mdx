...
api_key_rerank = "AZURE_RERANK_INFERENCE_CREDENTIAL"
endpoint_rerank = "AZURE_RERANK_ENDPOINT"  # example: "https://cohere-rerank-v3-multilingual-xyz.eastus.models.ai.azure.com/"
```
