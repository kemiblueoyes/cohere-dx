...
The Cohere platform allows you to leverage the power of large language models (LLMs) with just a few lines of code and an [API key](https://dashboard.cohere.com/api-keys?_gl=1*14v2pj5*_gcl_au*NTczMTgyMTIzLjE3MzQ1NTY2OTA.*_ga*MTAxNTg1NTM1MS4xNjk1MjMwODQw*_ga_CRGS116RZS*MTczNjI3NzU2NS4xOS4xLjE3MzYyODExMTkuNDkuMC4w).

Our [Command](../docs/command-a-plus), [Embed](../docs/cohere-embed), [Rerank](../docs/rerank), [Aya](../docs/aya), and [Cohere Transcribe](../docs/transcribe) models excel at a variety of applications, from the relatively simple ([semantic search](../docs/semantic-search-embed), and [content generation](../docs/introduction-to-text-generation-at-cohere)) to the more advanced ([retrieval augmented generation](../docs/retrieval-augmented-generation-rag) and [agents](../docs/multi-step-tool-use)). If you have a more specialized use case and custom data, you can also [train a custom model](../docs/fine-tuning) to get better performance.
