...
slug: reference/migrating-v1-to-v2
description: >-
  Migrate Cohere API v1 integrations to v2. Compare request and response
  changes across endpoints with side-by-side code examples.
keywords: "Cohere, text generation, LLMs, generative AI"
audience: Developer
---
Migrate your Cohere API v1 integrations to v2. This guide compares request and
response formats endpoint by endpoint, with side-by-side v1 and v2 code examples
for Chat, retrieval-augmented generation (RAG), tool use, and related
capabilities.
...
co_v1 = cohere.Client(api_key="COHERE_API_KEY")

# instantiating the new client
co_v2 = cohere.ClientV2(api_key="COHERE_API_KEY")
```
...
- v1: The `connectors` parameter was deprecated on September 15, 2025.
- v2: Use [user-defined tools](/docs/tools) instead.
...
## Citation quality in RAG and tool use
