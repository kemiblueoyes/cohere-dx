...
To see the full code sample, refer to this [notebook](https://github.com/cohere-ai/cohere-developer-experience/blob/main/notebooks/Cohere_Elastic_Guide.ipynb). You can also find an [integration guide](https://www.elastic.co/search-labs/integrations/cohere) on the Elasticsearch docsite.
...
- A Cohere production API Key. Get your API Key in the [dashboard](https://dashboard.cohere.com/welcome/login?redirect_uri=%2Fapi-keys) if you don't have one
...
If you don't have an Elastic Cloud deployment, [sign up](https://www.google.com/url?q=https%3A%2F%2Fcloud.elastic.co%2Fregistration%3Futm_source%3Dgithub%26utm_content%3Delasticsearch-labs-notebook) for a free trial and request access to Elastic Serverless
