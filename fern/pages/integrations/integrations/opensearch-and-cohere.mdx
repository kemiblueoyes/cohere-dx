---
title: Open Search and Cohere (Integration Guide)
slug: docs/opensearch-and-cohere
hidden: false
description: >-
  Unlock the power of search and analytics with OpenSearch, enhanced by ML
  connectors like Cohere and Amazon Bedrock.
