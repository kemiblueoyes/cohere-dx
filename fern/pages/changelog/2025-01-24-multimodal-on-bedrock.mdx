...
You can find more information about using Cohere’s embedding models on Bedrock in the [Cohere Models on Amazon Bedrock](https://docs.cohere.com/v1/docs/amazon-bedrock) section.
