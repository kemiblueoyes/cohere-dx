...
| Model Vault | A Cohere product for dedicated, managed inference: a single-tenant deployment you provision from the dashboard and call over the API. | [Model Vault docs](../docs/model-vault) |
