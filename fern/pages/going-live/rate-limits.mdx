...
<Note>Trial keys (and prod keys on newer Chat model variants) are limited to 1,000 API calls a month.</Note>

## Chat API (per model)

| Model               | Trial rate limit | Production rate limit                               |
| ------------------- | ---------------- | --------------------------------------------------- |
| Command A+          | 20 req / min     | Contact [sales@cohere.com](mailto:sales@cohere.com) |
