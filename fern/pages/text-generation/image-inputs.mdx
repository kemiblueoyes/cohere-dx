...
- What ultimately gets sent to the model is one 512px X 512px preview thumbnail in addition to eight tiles of 512px X 512px. Since the thumbnail is 256 tokens, and each of the eight tiles is 256 tokens, that means the image will take up 9 x 256 = 2304 tokens. 
